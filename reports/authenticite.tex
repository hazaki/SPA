...
Le client génère alors un paquet SPA chiffré avec cette clé et le serveur SPA le déchiffre avec la même clé. Il détermine la légitimité de la requête et si les champs sont valides, l'intégrité grâce au système de hachage
...
Nous calculons, ensuite, un haché de ces données et concaténons les deux (pour l'intégrité) puis le tout sera chiffré afin de préserver l'authenticité du paquet ainsi produit.\\
