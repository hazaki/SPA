...
Le système MD5, était considéré comme sûr avant que les chercheurs chinois, Xiaoyun Wang, Dengguo Feng, Xuejia Lai (co-inventeur de IDEA) et Hongbo Yu "} ne soient capables de trouver des collisions en quelques heures et le brisent.
...
Nous sommes donc, maintenant, capables de vérifier l'intégrité des données. Cependant, tout cela n'a pas de valeur si le haché n'est pas signé. Nous allons donc étudier le système de clé tout en gardant en tête le problème du rejeu.
